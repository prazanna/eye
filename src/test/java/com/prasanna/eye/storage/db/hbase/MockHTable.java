...
public class MockHTable implements HTableInterface {
   ...
   */
  private NavigableMap<byte[], NavigableMap<byte[], NavigableMap<byte[], NavigableMap<Long,
      byte[]>>>> data = new TreeMap<byte[], NavigableMap<byte[], NavigableMap<byte[], NavigableMap<Long,
   ...
   */
  private static List<KeyValue> toKeyValue(byte[] row, NavigableMap<byte[], NavigableMap<byte[], NavigableMap<Long,
      byte[]>>> rowdata, int maxVersions) {
   ...
   */
  private static List<KeyValue> toKeyValue(byte[] row, NavigableMap<byte[], NavigableMap<byte[], NavigableMap<Long,
      byte[]>>> rowdata, long timestampStart, long timestampEnd, int maxVersions) {
  ...
  private MockHTable(final String tableName) {
  ...
  private static void put(MockHTable ret, String row, String column,
    ...
    NavigableMap<byte[], NavigableMap<byte[], NavigableMap<Long, byte[]>>> families = ret.forceFind(ret.data,
        Bytes.toBytesBinary(row), new TreeMap<byte[], NavigableMap<byte[], NavigableMap<Long,
        byte[]>>>(Bytes.BYTES_COMPARATOR));
